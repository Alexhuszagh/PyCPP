...
TEST(has_right_shift_assign, has_right_shift_assign)
{
    ...
    static_assert(!has_right_shift_assign<pair>::value, "");
    static_assert(!has_right_shift_assign<pair, pair>::value, "");
    static_assert(!has_right_shift_assign<pair, int>::value, "");
    static_assert(!has_right_shift_assign<int, pair>::value, "");
}
