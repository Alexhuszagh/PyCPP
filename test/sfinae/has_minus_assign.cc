...
TEST(has_minus_assign, has_minus_assign)
{
    ...
    static_assert(!has_minus_assign<pair>::value, "");
    static_assert(!has_minus_assign<pair, pair>::value, "");
    static_assert(!has_minus_assign<pair, int>::value, "");
    static_assert(!has_minus_assign<int, pair>::value, "");
}
