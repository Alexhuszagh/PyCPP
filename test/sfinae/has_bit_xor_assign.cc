...
TEST(has_bit_xor_assign, has_bit_xor_assign)
{
    ...
    static_assert(!has_bit_xor_assign<p1>::value, "");
    static_assert(!has_bit_xor_assign<p1, p1>::value, "");
    static_assert(!has_bit_xor_assign<p1, int>::value, "");
    static_assert(!has_bit_xor_assign<int, p1>::value, "");
}
