...
{
    string buffer("\x42\x5a\x68\x39\x31\x41\x59\x26\x53\x59", 10);
...
{
    string buffer("\x78\x9c\xf3H\xcd\xc9\xc9\x07\x00\x05\x8c", 10);
    istringstream stream(buffer);
...
{
    string buffer("\x1f\x8b\x08\x08\x6d\xd9\xdc\x56\x00\x03", 10);
    istringstream stream(buffer);
...
{
    string buffer("\xfd\x37\x7a\x58\x5a\x00\x00\x04\xe6\xd6", 10);
    istringstream stream(buffer);
...
{
    string buffer("\x02\x01\x13\x08\x05\x00\x00\x00\x01\x00", 10);
    istringstream stream(buffer);
