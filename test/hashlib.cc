...
TEST(cryptographic_hash, digest)
{
    EXPECT_EQ(cryptographic_hash(md2_hash_algorithm, "LOWER").hexdigest(), "F6A2EBAF32C712B834BC2955EF65B575");
    EXPECT_EQ(cryptographic_hash(md4_hash_algorithm, "LOWER").hexdigest(), "0A5F25A7ADAE4B5FC3CD6F2EC94B4D18");
    EXPECT_EQ(cryptographic_hash(md5_hash_algorithm, "LOWER").hexdigest(), "A7C48BA367E019D004BFB0239B85F2B3");
    EXPECT_EQ(cryptographic_hash(sha1_hash_algorithm, "LOWER").hexdigest(), "E2B5C793D8E006E471A5275E68ADFB98FE059DC4");
    EXPECT_EQ(cryptographic_hash(sha2_224_hash_algorithm, "LOWER").hexdigest(), "C9D1EEFFAF00E89B940C9D4145B21C06705EBF4EE69E37A0990E7429");
    EXPECT_EQ(cryptographic_hash(sha2_256_hash_algorithm, "LOWER").hexdigest(), "86543EDCC2F0F4CCD0057538969B1BFF79D03F4E3CE9807194398849359D5DB0");
    EXPECT_EQ(cryptographic_hash(sha2_384_hash_algorithm, "LOWER").hexdigest(), "ADF848E92DFE3057BBDEE2897AB0FBE86D7AA318E5DE6CE03E6D28FEED0ECE898230CFE20E695801A1070B3EDC240826");
    EXPECT_EQ(cryptographic_hash(sha2_512_hash_algorithm, "LOWER").hexdigest(), "4B7A8D37DA56C3AE6DC5B8EB18D3DF3576EF972F9B876A65DEF2DB2953A14023C6BFD1159EFE8BCFFC7FA143C768A1C480E04E74B56F3F23048EED60EACE0EFC");
    EXPECT_EQ(cryptographic_hash(sha3_224_hash_algorithm, "LOWER").hexdigest(), "CB4CBAC7A0964E0983DEEAB29F00D705688708C37EFA94DA211978DE");
    EXPECT_EQ(cryptographic_hash(sha3_256_hash_algorithm, "LOWER").hexdigest(), "7165F47727ACD26881A9B57D09AFA37DF34A62537C3F377F00FEFA66F762A2BD");
    EXPECT_EQ(cryptographic_hash(sha3_384_hash_algorithm, "LOWER").hexdigest(), "E4255D285558D7E79D14B5ACBA190F511DB7B0AEFD7DCD461656E4D9507F9CBC0CF86F13BCC20118AA33D80506B2FBE3");
    EXPECT_EQ(cryptographic_hash(sha3_512_hash_algorithm, "LOWER").hexdigest(), "AD287FDBB233F213A2D5DF760A9D232E146D732BAF19087AE8C6D75B716B91D88D811F778176BEDD0CEB3B387F8BDA6ABF805D20D6B68AD293160A859915D7AA");
    EXPECT_EQ(cryptographic_hash(whirlpool_hash_algorithm, "LOWER").hexdigest(), "C1D36C5B5C7122371E8A027507B12A3D4921AC1DEBF8F28934100A8820B89B727EDB8E8B3A3FAA23B8C448EFB15139E366698C51EEF673A488AABFD8CC84E817");
}
