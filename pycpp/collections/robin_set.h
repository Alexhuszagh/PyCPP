...
>
using robin_pg_set = robin_set<Key, Hash, KeyEqual, Allocator, StoreHash, GrowthPolicy>;
...
>
struct is_relocatable<robin_set<Key, Hash, KeyEqual, Allocator, StoreHash, GrowthPolicy>>: false_type
{};
