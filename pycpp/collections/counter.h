...
public:
    ...
    self& operator=(self&&);
    // TODO: implement....
    // TODO: need sfinae to check if the item is a pair...
    // If the item is a pair, then use one overload...
...
//    // MODIFIERS
//    TODO: update
//    TODO: need tgo check if the Iter is a key_value pair...
//    template <typename Iter> void update(Iter first, Iter last);
