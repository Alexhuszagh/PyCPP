...
>
struct is_relocatable<fixed_list<T, StackSize, Container>>: bool_constant<
        is_relocatable<typename fixed_list<T, StackSize, Container>::arena_type>::value &&
        is_relocatable<typename fixed_list<T, StackSize, Container>::container_type>::value
    >
{};
